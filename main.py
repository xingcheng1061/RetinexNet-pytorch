...
parser.add_argument('--test_dir', dest='test_dir', default='./data/our485/low', help='directory for testing inputs')
...
def lowlight_train(lowlight_enhance):
    ...
    lowlight_enhance.train(train_low_data, train_high_data, eval_low_data, batch_size=args.batch_size,
                           patch_size=args.patch_size, epoch=args.epoch, lr=args.start_lr, sample_dir=args.sample_dir,
